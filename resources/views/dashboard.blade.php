                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="mt-4 inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-lg">
                            ...
                            <span class="font-medium">Role: {{ ucfirst(auth()->user()->roles->first()->name ?? 'User') }}</span>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <a href="{{ route('transactions.index') }}" 
                   class="group flex items-center p-6 bg-gradient-to-br from-green-50 to-green-100 hover:from-green-100 hover:to-green-200 rounded-xl transition-all duration-200 transform hover:scale-105 hover:shadow-lg">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-900 group-hover:text-green-700">Transaksi</h3>
                        <p class="text-sm text-gray-600">Pinjam dan kembalikan buku</p>
                    </div>
                </a>
                @endrole
                ...
                <form method="POST" action="{{ route('logout') }}" class="w-full">
                    @csrf
                    <button type="submit"
                       class="group w-full flex items-center p-6 bg-gradient-to-br from-red-50 to-red-100 hover:from-red-100 hover:to-red-200 rounded-xl transition-all duration-200 transform hover:scale-105 hover:shadow-lg text-left">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 group-hover:text-red-700">Keluar</h3>
                            <p class="text-sm text-gray-600">Logout dari sistem</p>
                        </div>
                    </button>
                </form>
            </div>
